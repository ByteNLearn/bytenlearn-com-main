                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
                    <div className="md:col-span-5">
                        ...
                        <p className="text-brand-white/60 max-w-sm text-balance">
                            Empowering tech enthusiasts with world-class education in AI, Web, and Cyber Security. Build your future with us.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-3">
                        ...
                        <ul className="space-y-4 font-body text-brand-white/80">
                            ...
                            <li><Link href="/tutorials" className="hover:text-brand-orange transition-colors">Tutorials</Link></li>
                            <li><Link href="/blog" className="hover:text-brand-orange transition-colors">Blog</Link></li>
                            <li><Link href="/notes" className="hover:text-brand-orange transition-colors">Notes</Link></li>
                        </ul>
                    </div>
