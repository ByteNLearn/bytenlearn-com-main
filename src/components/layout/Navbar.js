...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <nav className={`fixed top-[3px] left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'py-4 bg-brand-white/80 dark:bg-brand-black/80 backdrop-blur-md border-b border-brand-black/10 dark:border-brand-white/10 shadow-sm' : 'py-6 bg-transparent'}`}>
