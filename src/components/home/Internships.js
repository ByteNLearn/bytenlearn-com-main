...
const opportunities = [
    {
        ...
        duration: "3 Months",
        perks: ["Live Classes", "Real Projects", "Certificate", "Placement Assistance"],
    ...
    },
    {
        ...
        role: "Full Stack Masterclass",
        duration: "6 Months",
        perks: ["1-on-1 Mentorship", "Industrial Training", "Job Guarantee", "Global Certification"],
