    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-brand-white dark:bg-brand-black">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    Unlock your potential with <span className="text-brand-orange font-bold">industry-ready skills</span> in AI, Web, and Cyber Security. Join the <b className="text-brand-black dark:text-brand-white">Premier Tech Learning Platform</b> today.
                </motion.p>
                ...
                >
                    <a href="#internships" className="px-10 py-5 bg-brand-black text-brand-white dark:bg-brand-white dark:text-brand-black font-display font-bold text-xl uppercase tracking-widest hover:scale-105 transition-transform shadow-xl">
                        Internships
                    </a>
